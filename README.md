...
[Portfolio](https://annaeliana7.github.io/Portfolio/)
...
- On the terminal run this command git clone `git clone https://github.com/annaeliana7/Portfolio.git`

- Go to the repository folder using command prompt cd `Portfolio`
...
- On the terminal run this command git clone https://github.com/annaeliana7/Portfolio.git
...
Feel free to check the [issues page](https://github.com/annaeliana7/Portfolio/issues).
